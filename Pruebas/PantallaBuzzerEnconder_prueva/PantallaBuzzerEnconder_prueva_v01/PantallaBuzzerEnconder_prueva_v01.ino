...
void setup() {
  ...
  Serial.println("=== Menu con Encoder y Animacion ===");
}
...
void loop() {
  ...
  u8g2.drawStr(4, 10, "HP 99/99");
  u8g2.drawBox(100, 2, 20, 8);
  ...
  for (int i = 0; i < numOpciones; i++) {
    int y = 15 + i*12;  // Posición vertical
    if (i == seleccion) {
      u8g2.drawStr(0, y, ">");  // Triangulo
    }
